<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Assignment1.Register" %>
...
<div class="container-fluid">
    ...
    <tr>
        ...
        <td>
            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtPhone" Text= "*" ErrorMessage="*"  ForeColor="Red" />
            <asp:RegularExpressionValidator ControlToValidate="txtPhone" validationexpression="^\s*\+?\s*([0-9][\s-]*){9,}$" ErrorMessage="Please enter a phone number" runat="server" />  
    ...
    <tr>
        ...
        <td>
            <asp:Button Text="Submit" CssClass="btn" runat="server" OnClick="RegisterUser" />
        </td>
        <td>
        </td>
    </tr>
