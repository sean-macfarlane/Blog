<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMenu.Master" AutoEventWireup="true" CodeBehind="EditBlogPost.aspx.cs" Inherits="Assignment1.Admin.EditBlogPost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td>
            <asp:Button Text="Save Changes" runat="server" OnClick="EditPost" />
        </td>
        <td>
        </td>
    </tr>
